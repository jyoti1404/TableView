...
public class TableFixHeaders extends ViewGroup {
	...
	public TableFixHeaders(Context context, AttributeSet attrs) {
		...
		this.shadows[0].setImageResource(com.inqbarna.tablefixheaders.R.drawable.shadow_left);
		this.shadows[1] = new ImageView(context);
		this.shadows[1].setImageResource(com.inqbarna.tablefixheaders.R.drawable.shadow_top);
		this.shadows[2] = new ImageView(context);
		this.shadows[2].setImageResource(com.inqbarna.tablefixheaders.R.drawable.shadow_right);
		this.shadows[3] = new ImageView(context);
		this.shadows[3].setImageResource(com.inqbarna.tablefixheaders.R.drawable.shadow_bottom);

		this.shadowSize = getResources().getDimensionPixelSize(com.inqbarna.tablefixheaders.R.dimen.shadow_size);
	...
	public void removeView(View view) {
		...
		final int typeView = (Integer) view.getTag(com.inqbarna.tablefixheaders.R.id.tag_type_view);
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		final Integer row = (Integer) child.getTag(com.inqbarna.tablefixheaders.R.id.tag_row);
		final Integer column = (Integer) child.getTag(com.inqbarna.tablefixheaders.R.id.tag_column);
	...
	private View makeView(int row, int column, int w, int h) {
		...
		view.setTag(com.inqbarna.tablefixheaders.R.id.tag_type_view, itemViewType);
		view.setTag(com.inqbarna.tablefixheaders.R.id.tag_row, row);
		view.setTag(com.inqbarna.tablefixheaders.R.id.tag_column, column);
